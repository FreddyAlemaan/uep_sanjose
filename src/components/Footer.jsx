...
const COLS = [
  {
    titulo: 'Institución',
    links: [
      { label: 'El Colegio',       path: '/el-colegio' },
      { label: 'Historia',         path: '/historia'   },
      { label: 'Misión y Visión',  path: '/el-colegio' },
      { label: 'Vida Estudiantil', path: '/vida'       },
  ...
  },
  {
    titulo: 'Académico',
    links: [
      { label: 'Preescolar',         path: '/academico' },
      { label: 'Educación Básica',   path: '/academico' },
      { label: 'Bachillerato Técnico', path: '/academico' },
      { label: 'Admisiones',         path: '/admision'  },
    ],
  },
  {
    titulo: 'Contacto',
    links: [
      { label: 'Carayaca, Estado La Guaira', path: '/contacto' },
      { label: 'info@uepsanjose.edu.ve',     path: '/contacto' },
      { label: 'Lun–Vie: 7:00am – 4:00pm',  path: '/contacto' },
    ...
    <footer className="bg-primary-dark text-white/70">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              ...
              personas íntegras en Carayaca, Estado La Guaira, Venezuela.
            </p>
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-xs text-white/40">
          © {AÑO} U.E.P. San José de Carayaca · Todos los derechos reservados
        </div>
      </div>
    </footer>
  );
